...
const privacySections = [
  {
    ...
    detail: 'This includes your email address, scan records, waste classification results, and location data used for disposal facility routing. We do not sell this data to third parties.',
  ...
  },
  {
    ...
    detail: 'All data is transmitted over HTTPS. Passwords are hashed and never stored in plain text. Role-based access control ensures only authorized users can access sensitive data.',
  ...
  },
  {
    ...
    detail: 'You may request a full export of your scan history at any time. Account deletion removes all associated records from our systems within 30 days of the request.',
            ...
            <div className="hero-content" style={{ gridTemplateColumns: '1fr' }}>
              <motion.div className="hero-left" variants={fadeUp} style={{ maxWidth: '720px' }}>
                ...
                <p className="hero-desc">
                  This policy describes what OrganiSort stores, how it is used, and the controls available to you.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div className="mb-14" variants={fadeUp}>
              <p className="section-label">Privacy Highlights</p>
              <h2 className="section-title">Your data, explained</h2>
              <p className="section-subtitle mt-3">The key principles that govern how we handle your information.</p>
            </motion.div>
              ...
              {privacySections.map((s, i) => (
                ...
                >
                  ...
                  <div className="p-7 flex flex-col flex-1">
                    <p className="text-xs font-bold text-green-600 uppercase tracking-widest mb-2">Privacy</p>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div className="bg-white rounded-[2rem] p-10 md:p-14 border border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-8" variants={fadeUp}>
              <div>
                <p className="section-label mb-2">Our Commitment</p>
                <h3 className="text-2xl md:text-3xl font-black tracking-tighter text-gray-900 mb-2">We never sell your data</h3>
                <p className="text-gray-400 font-medium text-sm max-w-md">OrganiSort does not monetize user data through advertising or third-party data brokers. Your scan records are yours.</p>
              </div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '999px', padding: '10px 20px', flexShrink: 0 }}>
                <span style={{ fontSize: '18px' }}>🛡️</span>
                <span style={{ color: '#16a34a', fontSize: '13px', fontWeight: 700 }}>Privacy First</span>
              </div>
            </motion.div>
          </div>
        </motion.section>
