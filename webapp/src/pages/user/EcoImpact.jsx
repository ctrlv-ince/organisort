    ...
    const impactCards = data?.impact ? [
        {
            ...
            value: `${Math.abs(parseFloat(data.impact.co2_kg) || 0).toFixed(1)} kg`,
            color: '#10b981',
            bg: '#ecfdf5',
        },
        {
            ...
            value: `${Math.abs(parseFloat(data.impact.landfill_kg) || 0).toFixed(1)} kg`,
            color: '#3b82f6',
            bg: '#eff6ff',
        },
        {
            ...
            value: `${Math.abs(parseFloat(data.impact.water_liters) || 0).toFixed(0)} L`,
            color: '#0ea5e9',
            bg: '#f0f9ff',
        },
        {
            ...
            value: `${Math.abs(parseFloat(data.impact.trees_equivalent) || 0).toFixed(2)}`,
            color: '#16a34a',
            bg: '#f0fdf4',
        },
    ] : [];
